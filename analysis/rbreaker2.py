...
from tqsdk import TqApi, TqSim, TargetPosTask,TqBacktest
...
api = TqApi(TqSim(), backtest=TqBacktest(
    start_dt=datetime(2019, 2, 1, 21, 00, 0), end_dt=datetime(2019, 5, 15, 15, 0, 0)))
# api = TqApi()
print("策略开始运行")
