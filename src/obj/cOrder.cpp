...
bool cOrder::IsPendingOrder() const {
    return ((m_status != THOST_FTDC_OST_PartTradedNotQueueing) && (m_status != THOST_FTDC_OST_Canceled) &&
            (m_status != THOST_FTDC_OST_AllTraded) && (m_status != THOST_FTDC_OST_Unknown));
}
