...
cMarketData* helloWorld::GetMarketDataHandle(const string& name) {
...
cMarketDataPtr helloWorld::GetMarketDataHandleSharedPtr(const string& name) {
    marketdataHandeWorld::iterator it = _m_mkt_handle.find(name);
...
void helloWorld::OnRtnDepthMarketData(CThostFtdcDepthMarketDataField* pDepthMarketData) {
...
// 读取历史数据
void helloWorld::loadSeriesHistory(string          inst,
                                              string          startDate,
                                              string          endDate,
                                              vector<double>& open,
                                              vector<double>& high,
...
void helloWorld::loadHistoryFromMongo(string          collection,
                                                 string          sDateTime,
                                                 string          eDateTime,
                                                 vector<double>& open,
                                                 vector<double>& high,
