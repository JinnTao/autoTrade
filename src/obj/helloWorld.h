#ifndef __CHELLOWORLD_H__
#define __CHELLOWORLD_H__
...
typedef map<string, cMarketDataPtr> marketdataHandeWorld;
class helloWorld {
public:
    helloWorld();
    virtual ~helloWorld();
...
protected:
    marketdataHandeWorld _m_mkt_handle;
...
typedef shared_ptr<helloWorld> cMarketDataHelloWorld;
